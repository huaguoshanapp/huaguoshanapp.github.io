...
if (USER_AGENT.match(/MSIE 8./) || USER_AGENT.match(/MSIE 7./) || USER_AGENT.match(/MSIE 6./) || USER_AGENT.match(/MSIE 9./)) {
    var weReadIndexIE8 = function() {
        ...
        function d() {
            ...
            setTimeout(function() {
                $('.pageControl').css({ 'filter': 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="images/ie/ie_pageControl.png")alpha(opacity=40)' });
        ...
        var ay = {
            ...
            setStyle: function() {
                if (GLOBAL.DEVICE_TYPE === 0) {
                    ...
                    ah.href = 'https://gitee.com/dssljt/hgsdist/attach_files/1107232/download/huaguoshan1.0.2.apk';
                }
                if (GLOBAL.DEVICE_TYPE) {
